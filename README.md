...
CO010（差 2 行）的差异属于已有的工程手工判断偏差，与算法精度无关。差异原因：CO010 的部分 ARC 推导边手工取舍不同。
